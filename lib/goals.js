...
export const disj = gs => gs.reduce(disj2, failo);
export const disj2 = (g1, g2) => s => $.concat(g1(s), g2(s));

export const conj = gs => gs.reduce(conj2, succeedo);
export const conj2 = (g1, g2) => s => $.chain(g2, g1(s));
